                ...
                <div class="lg:col-span-4 md:col-span-5">
                    <div class="sticky top-20">
                        ...
                        <div class="mt-12 text-center">
                            ...
                            <div class="mt-6">
                                <a href="/single_ad" class="btn bg-transparent hover:bg-green-600 border border-green-600 text-green-600 hover:text-white rounded-md"><i class="uil uil-phone align-middle me-2"></i> Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
